          ...
          >
            ...
            <template v-if="!match._blur">
              ...
              <div v-if="match.prediction_basis" class="mc-summary">
                <span class="mc-summary-icon">💡</span>
...
.key-match-card {
  border: 2px solid #fbbf24; box-shadow: 0 4px 16px rgba(245,158,11,0.1);
}
...
.corner-multi { background: linear-gradient(135deg, #7c3aed, #6d28d9); }
...
.card-title-section { margin-bottom: 16px; padding-bottom: 14px; border-bottom: 1px solid #f0f0f5; }
.card-title { font-size: 17px; font-weight: 700; color: #1a1a2e; line-height: 1.5; display: block; }

/* ========== ANALYSIS ========== */
.analysis-section { background: #f8fafc; border-radius: 12px; padding: 20px; border: 1px solid #e8ecf2; }
.single-matches { display: flex; flex-direction: column; gap: 14px; }

/* ========== MATCH CARD ========== */
.match-card {
  background: #fff; border-radius: 16px; padding: 22px 24px;
  border: 1px solid #e8ecf2; position: relative;
...
.match-card.mc-featured { border: 2px solid #e9d5ff; background: #faf8ff; box-shadow: 0 4px 12px rgba(139,92,246,0.1); }
...
.mc-tag-featured { color: #7c3aed; background: #faf8ff; border: 1px solid #e9d5ff; }
...
.mc-tag-confidence.rate-normal { color: #2563eb; background: #eff6ff; border: 1px solid #bfdbfe; }
.mc-tag-confidence.rate-normal .mc-dot { background: #2563eb; }
...
.mc-team { flex: 1; text-align: center; font-size: 19px; font-weight: 800; color: #1a1a2e; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; }
.mc-vs-divider { width: 60px; height: 44px; display: flex; align-items: center; justify-content: center; background: #f1f5f9; border-radius: 10px; flex-shrink: 0; }
.mc-vs-divider span { font-size: 12px; font-weight: 700; color: #94a3b8; }
...
.mc-upgrade-hint {
  display: flex; align-items: center; justify-content: center;
  padding: 14px 0 4px; border-top: 1px solid #f0f0f0; margin-top: 8px;
